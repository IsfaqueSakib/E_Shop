              ...
              <?php $customer_id=Session::get('customer_id');
               ...
               ?>
                ...
                <?php if($customer_id != NULL){ ?>
								          <li><a href="{{URL::to('/user_profile/'.$customer_id)}}"><i class="fa fa-user"></i> {{ Session::get('customer_name') }} </a></li>
                <?php } else{ ?>
                ...
                <?php } elseif($customer_id == NULL && $shipping_id == NULL){ ?>
                       <li><a href="{{URL::to('/login_check')}}"><i class="fa fa-lock"></i> Checkout </a></li>
               <?php } ?>
