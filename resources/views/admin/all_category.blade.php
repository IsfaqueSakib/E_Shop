					...
					@foreach ($all_category_info as $v_category)
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									@if($v_category->publication_status==1)
									<a class="btn btn-danger" href="{{URL::to('/inactiveCategory/'.$v_category->category_id)}}">
										<i class="halflings-icon white thumbs-down"></i>
									</a>
									@else
									<a class="btn btn-success" href="{{URL::to('/activeCategory/'.$v_category->category_id)}}">
										<i class="halflings-icon white thumbs-up"></i>
									</a>
									@endif
									<a class="btn btn-info" href="{{URL::to('/editCategory/'.$v_category->category_id)}}">
