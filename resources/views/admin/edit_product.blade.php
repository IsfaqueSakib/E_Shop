...
<ul class="breadcrumb">
			...
			<div class="row-fluid sortable">
              ...
              <div class="control-group">
							  ...
							  <div class="controls">
								<input class="input-file uniform_on" name="product_image" id="fileInput" value="{{$product_info->product_image}}" type="file">
							  </div>
							</div>
              ...
              <div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" class="input-xlarge" name="discount" value="{{$product_info->discount}}" required="">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								 <input type="text" name="from_date" id="from_date" class="input-xlarge" value="{{$product_info->from_date}}"/>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								<input type="text" name="to_date" id="to_date" class="input-xlarge"  value="{{$product_info->to_date}}"/>
								</div>
							</div>
