...
class CategoryController extends Controller
{
    ...
    public function inactive_category($category_id)
    {
        ...
        Session::put('message','Category publication is OFF now !!!');
    ...
    public function active_category($category_id)
    {
        ...
        Session::put('message','Category publication is ON now !!!');
        return Redirect::to('/allCategory');
    }
    ...
    public function admin_allCategory_search()
    {
      $key=Input::get('search');
      $all_category_info=DB::table('tbl_category')
                            ->select('tbl_category.*')
                            ->where('tbl_category.category_name', 'LIKE', '%' .$key. '%')
                            ->get();
      $manage_category=view('admin.all_category')
              ->with('all_category_info',$all_category_info);
