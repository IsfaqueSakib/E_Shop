...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url(<?php echo e(URL::to('backend/img/bg-login.jpg')); ?>) !important; }
		</style>
...
?></p>
	...
	<!-- start: JavaScript-->
		...
		<script src="<?php echo e(('backend/js/jquery-1.9.1.min.js')); ?>"></script>
  	<script src="<?php echo e(('backend/js/jquery-migrate-1.0.0.min.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/jquery-ui-1.10.0.custom.min.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/modernizr.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/bootstrap.min.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/jquery.cookie.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/excanvas.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/jquery.uniform.min.js')); ?>"></script>
		<script src="<?php echo e(('backend/js/custom.js')); ?>"></script>
	<!-- end: JavaScript-->
