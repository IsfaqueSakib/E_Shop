			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo e(url('/save_slider')); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="control-group hidden-phone">
                ...
                <div class="controls">
                <input type="checkbox" name="publication_status" value="1" required=""></input>
                </div>
              </div>
