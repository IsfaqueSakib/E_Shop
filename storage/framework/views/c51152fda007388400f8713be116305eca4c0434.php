...
<body>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> <?php echo e(Session::get('admin_name')); ?>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo e(URL::to('/logout')); ?>"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo e(URL::to('/dashboard')); ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						<li><a href="<?php echo e(URL::to('/allCategory')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="<?php echo e(URL::to('/addCategory')); ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/addProduct')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/allProduct')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
							</ul>
						</li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/addSlider')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Slider</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/allSlider')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
							</ul>
						</li>


						<li><a href="<?php echo e(URL::to('/manage_order')); ?>"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Order</span></a></li>
						<!-- <li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name</span></a></li> -->
						<li><a href="<?php echo e(URL::to('/set_charges')); ?>"><i class="icon-picture"></i><span class="hidden-tablet"> Charges</span></a></li>
	...
	<!-- start: JavaScript-->
	  ...
	  <script src="<?php echo e(asset('backend/js/jquery.flot.resize.min.js')); ?>"></script>
		...
		<script type="text/javascript" src="<?php echo e(asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.3.2/bootbox.min.js')); ?>"></script>
		<script>
