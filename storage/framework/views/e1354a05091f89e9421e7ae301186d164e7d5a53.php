...
<div class="row-fluid sortable">
				...
				<div class="box span6">
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									...
									<td><?php echo e($v_order->shipping_first_name." ".$v_order->shipping_last_name); ?></td>
      ...
      <div class="row-fluid sortable">
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<tfoot>
									<tr>
										...
										<td><strong><?php echo e(ceil($v_order->order_total + $v_order->order_total*$charges->vat/100 + $charges->delivery_charge - $total_discount)); ?> TK</strong></td>
									</tr>
								</tfoot>
                ...
                <tfoot>
                  <tr>
                    ...
                    <td><strong><?php echo e(ceil($v_order->order_total)); ?> TK</strong></td>
                  </tr>
                </tfoot>
								...
								<tfoot>
									<tr>
										...
										<td><strong>+<?php echo e(ceil($v_order->order_total*$charges->vat/100)); ?> TK</strong></td>
									</tr>
								</tfoot>
                  ...
                  <tr>
                    ...
                    <td><strong>+<?php echo e($charges->delivery_charge); ?> TK</strong></td>
                  </tr>
                </tfoot>
                  ...
                  <tr>
                    ...
                    <td><strong>-<?php echo e(ceil($total_discount)); ?> TK</strong></td>
                  </tr>
                </tfoot>
