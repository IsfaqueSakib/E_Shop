...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="<?php echo e(URL::to('frontend/images/ico/favicon.ico')); ?>">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo e(URL::to('frontend/images/ico/apple-touch-icon-144-precomposed.png')); ?>">
              ...
              <?php $customer_id=Session::get('customer_id');
               ...
               ?>
                ...
                <?php if($customer_id != NULL){ ?>
								          <li><a href="<?php echo e(URL::to('/user_profile/'.$customer_id)); ?>"><i class="fa fa-user"></i> <?php echo e(Session::get('customer_name')); ?> </a></li>
                <?php } else{ ?>
                ...
                <?php } elseif($customer_id == NULL && $shipping_id == NULL){ ?>
                       <li><a href="<?php echo e(URL::to('/login_check')); ?>"><i class="fa fa-lock"></i> Checkout </a></li>
               <?php } ?>
								<li><a href="<?php echo e(URL::to('/show_cart')); ?>"><i class="fa fa-shopping-cart"></i> Cart (<?php echo e(Cart::count()); ?>)</a></li>

                <?php $customer_id=Session::get('customer_id'); ?>
                <?php if( $customer_id != NULL ) { ?>
								        <li><a href="<?php echo e(URL::to('/customer_logout')); ?>"><i class="fa fa-lock"></i> Logout</a></li>
                <?php } else{ ?>
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
                ...
                <li><a href="contact-us.html">Contact</a></li>
								 <li class="dropdown"><a href="#">Filter By<i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="sub-menu">
                    <li><a href="/filter_by_price">Price</a></li>
                    <li><a href="/filter_by_discount">Discount</a></li>
                  </ul>
                </li>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(asset('frontend/images/home/iframe1.png')); ?>" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(asset('frontend/images/home/iframe2.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(asset('frontend/images/home/iframe3.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(asset('frontend/images/home/iframe4.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="<?php echo e(asset('frontend/images/home/map.png')); ?>" alt="" />
