							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="#">Shwapno</a></li>
										<li><a href="#">Agora</a></li>
										<li><a href="#">Fiza & company</a></li>
										<li><a href="#">Hut Bazar</a></li>
										<li><a href="#">Meena Bazar</a></li>
										<li><a href="#">Sondhan</a></li>
                                    </ul>
                                </li>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('frontend/images/home/vegitable.jpg')); ?>" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('frontend/images/home/fish&meat.jpg')); ?>" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('frontend/images/home/fruits.jpg')); ?>" class="girl img-responsive" alt="" />
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#Fruit & vegetable">
